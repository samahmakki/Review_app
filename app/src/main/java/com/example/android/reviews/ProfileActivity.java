...
public class ProfileActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.home) {
            ...
            Intent i = new Intent(ProfileActivity.this, AddLocationActivity.class);
            startActivity(i);
        }
        else if (id == R.id.business_page) {

            Intent i = new Intent(ProfileActivity.this, BusinessBageActivity.class);
            startActivity(i);
        }
            ...
            Intent i = new Intent(ProfileActivity.this, RateActivity.class);
            startActivity(i);
        }
        else if (id == R.id.developers){
            Intent i = new Intent(ProfileActivity.this, DevelopersActivity.class);
            startActivity(i);
        }
        else if (id == R.id.share) {

            Intent i = new Intent(ProfileActivity.this, ShareActivity.class);
            startActivity(i);
        }
            ...
            Intent i = new Intent(ProfileActivity.this, LogOutActivity.class);
            startActivity(i);
        }
